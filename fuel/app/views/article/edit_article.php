        ...
        <?php foreach ($fields as $key => $label): ?>
            <div class="form-group">
                ...
                <?php if ($key == 'description'): ?>
                    <?php echo Form::textarea($key, Input::post($key, isset($data->$key) ? ($key == 'date') ? date('d/m/Y', $data->$key) : $data->$key : ''), array('class' => 'col-md-4 form-control', 'rows'=>20,'cols'=>30,'placeholder' => "Enter " . $label)); ?>

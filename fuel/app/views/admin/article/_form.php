	...
	<fieldset>
		<div class="form-group">
			<?php echo Form::label('Category id', 'category_id', array('class'=>'control-label')); ?>
				...
				<?php echo Form::input('category_id', Input::post('category_id', isset($article) ? $article->category_id : ''), array('class' => 'col-md-4 form-control', 'placeholder'=>'Category id')); ?>
		...
		<div class="form-group">
			<?php echo Form::label('Image', 'image', array('class'=>'control-label')); ?>
				...
				<?php echo Form::input('image', Input::post('image', isset($article) ? $article->image : ''), array('class' => 'col-md-4 form-control', 'placeholder'=>'Image')); ?>
